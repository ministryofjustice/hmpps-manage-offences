...
export default class AuthTokenService {
  ...
  async getSystemClientToken(username?: string): Promise<string> {
    ...
    const newToken = await this.getSystemClientTokenFromHmppsAuth(username)
  ...
  private getSystemClientTokenFromHmppsAuth(username?: string): Promise<superagent.Response> {
